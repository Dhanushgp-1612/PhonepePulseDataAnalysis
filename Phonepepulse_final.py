...
path = "C:/Users/gpdha/guvids/Git clone/pulse/data/aggregated/transaction/country/india/state/"
...
path = "C:/Users/gpdha/guvids/Git clone/pulse/data/aggregated/user/country/india/state/"
...
path = "C:/Users/gpdha/guvids/Git clone/pulse/data/map/transaction/hover/country/india/state/"
...
path = "C:/Users/gpdha/guvids/Git clone/pulse/data/map/user/hover/country/india/state/"
...
path = "C:/Users/gpdha/guvids/Git clone/pulse/data/top/transaction/country/india/state/"
...
path = "C:/Users/gpdha/guvids/Git clone/pulse/data/top/user/country/india/state/"
USER_list = os.listdir(path )
...
df_aggregated_transaction = pd.read_csv('/Users/gpdha/guvids/Git clone/pulse/aggregated_transaction')


# TO GET THE DATA-FRAME OF AGGREGATED <--> USER
df_aggregated_user=pd.read_csv('/Users/gpdha/guvids/Git clone/pulse/aggregated_user')

# TO GET THE DATA-FRAME OF MAP <--> TRANSACTION
df_map_transaction=pd.read_csv('/Users/gpdha/guvids/Git clone/pulse/map_transaction')

# TO GET THE DATA-FRAME OF MAP <--> USER
df_map_user=pd.read_csv('/Users/gpdha/guvids/Git clone/pulse/map_user')

# TO GET THE DATA-FRAME OF TOP <--> TRANSACTION
df_top_transaction=pd.read_csv('/Users/gpdha/guvids/Git clone/pulse/top_transaction')

# TO GET THE DATA-FRAME OF TOP <--> USER
df_top_user=pd.read_csv('/Users/gpdha/guvids/Git clone/pulse/top_user')
...
def main():
    ...
    with tab2:
        ...
        options = ["--select--",
                ...
                "Registered Users based on Year and Quater"]
